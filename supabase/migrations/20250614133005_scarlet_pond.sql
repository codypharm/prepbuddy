/*
  ...
  2. Security
    - Enable RLS on `auth_errors` table
    - Add policy for users to view their own auth errors
    - Add policy for service role to manage auth errors

  3. Functions
    - Create function to handle auth error logging

  Note: Email confirmation settings should be configured in the Supabase Dashboard
  under Authentication > Settings > Email Auth > "Confirm email" toggle
*/
